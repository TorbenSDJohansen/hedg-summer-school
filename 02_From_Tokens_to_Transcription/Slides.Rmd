...
.center[
<img src="Figures/Performance_by_lang_greedy.png" alt="Performance by language" style="height:480px;">
]
...
.center[
<img src="Figures/Plot_tsne_2d.png" alt="t-SNE" style="height:380px;">
]
...
.pull-left-wide[
- All of this is repeated [here in a step-by-step guide](https://github.com/christianvedels/OccCANINE/blob/main/GETTING_STARTED.md)
...
.pull-left-wide[
We will go over this notebook: [github.com/christianvedels/OccCANINE/blob/main/demonstration.ipynb](https://github.com/christianvedels/OccCANINE/blob/main/demonstration.ipynb)
]
...
.pull-left-wide[
**Day 1: Off-the-shelf models & debiasing**
- Running pre-trained models via the HuggingFace `pipeline` interface, for both vision and text
- Every model output is a prediction, not an observation
- Debiasing (PPI, DSL) corrects predictions using a small gold-standard sample

**Day 2: From tokens to transcription**
- Neural networks for text: RNNs, LSTM, GRU
- Building a text classifier from scratch: *OccCANINE*
- Transcription: handwritten text recognition and LLMs for OCR
]
