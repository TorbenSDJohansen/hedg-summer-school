...
1. Generate a random sample of size $N = 1000$ according to the above data generating process. Remove $Y_i$ from 90% of the sample
...
**TODO slide with figure ppi-vs-dsl-lhs.png and a coverage table based on numbers from ppi-vs-dsl-lhs-coverage.tex**
